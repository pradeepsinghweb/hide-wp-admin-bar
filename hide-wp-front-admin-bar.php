<?php
/*
 * Plugin Name: Hide WP Front Admin Bar
 ...
 * Text Domain: hide-wp-front-admin-bar
 */

class HIDE_WP_FRONT_ADMIN_BAR{
    ...
    static function getInstance() {
        ...
        if( empty($instance) ) {
            $instance = new HIDE_WP_FRONT_ADMIN_BAR();
        }
    ...
    public function applyActions($action,$data){
        ...
        if($action == 'HIDE_WP_FRONT_ADMIN_BAR'){
    ...
    public function add_plugin_settings_page_callback(){
        ...
        <?php } ?>
        <?php ?>
        <div class="hide-wp-front-admin-bar-form">
            <form action="" method="post" id="hide-wp-front-admin-bar-form">
                ...
                <p class="submit">
                    <input type="hidden" name="frm-action" value="HIDE_WP_FRONT_ADMIN_BAR" />
                    <?php wp_nonce_field('HIDE_WP_FRONT_ADMIN_BAR'); ?>
    ...
    public function plugin_action_links($links){
        unset( $links['edit'] );
        $links['manage'] = '<a href="' . admin_url('options-general.php?page=hide-wp-front-admin-bar') . '">'.__('Settings', 'hide-wp-front-admin-bar').'</a>';
        return $links;
    }

}
HIDE_WP_FRONT_ADMIN_BAR::getInstance();